...
public class CarServiceImpl implements CarService {
  ...
  private int id = 1;
	...
	public CarServiceImpl() {
      carList.add(new CarDTO(id++, "Primera", "Nissan",
          ...
          "http://placecorgi.com/260/180", 23320));
      carList.add(new CarDTO(id++, "Cefiro", "Nissan",
          ...
          "http://placecorgi.com/260/180", 38165));
      carList.add(new CarDTO(id++, "Camry", "Toyota",
          ...
          "http://placecorgi.com/260/180", 24170));
      carList.add(new CarDTO(id++, "Century", "Toyota",
          ...
          "http://placecorgi.com/260/180", 28730));
      carList.add(new CarDTO(id++, "Sigma", "Mitsubishi",
          ...
          "http://placecorgi.com/260/180", 54120));
      carList.add(new CarDTO(id++, "Challenger", "Mitsubishi",
          ...
          "http://placecorgi.com/260/180", 58750));
      carList.add(new CarDTO(id++, "Civic", "Honda",
          ...
          "http://placecorgi.com/260/180", 17479));
      carList.add(new CarDTO(id++, "New Beetle", "Volkswagen",
          ...
          "http://placecorgi.com/260/180", 67540));
      carList.add(new CarDTO(id++, "Golf V", "Volkswagen",
          ...
          "http://placecorgi.com/260/180", 78200));
      carList.add(new CarDTO(id++, "Neon", "Chrysler",
          ...
          "http://placecorgi.com/260/180", 85400));
	}
