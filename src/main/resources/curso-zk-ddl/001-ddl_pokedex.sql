...
COMMENT ON COLUMN REGION.ID_REGION IS 'The identifier for this resource.';
COMMENT ON COLUMN REGION.NOMBRE IS 'The name for this resource.';
...
COMMENT ON COLUMN POKEMON.ID_REGION IS 'Original region of the Pokémon.';
